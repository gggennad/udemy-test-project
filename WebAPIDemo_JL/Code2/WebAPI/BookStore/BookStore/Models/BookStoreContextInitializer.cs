...
{
    public class BookStoreContextInitializer : DropCreateDatabaseAlways<BookStoreContext> // DropCreateDatabaseIfModelChanges<BookStoreContext>
    {
        protected override void Seed(BookStoreContext context)
        {
            ...
            var order = new Order() { Customer = "John Doe", OrderDate = new DateTime(2013, 12, 18) };
